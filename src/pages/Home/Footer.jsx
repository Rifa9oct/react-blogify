...
const Footer = () => {
    return (
        <div className="my-6 md:my-8 bg-[#030317]">
                ...
                <ul className="flex items-center space-x-5">
                    <li className="text-center">
                        <a className="text-white/50 hover:text-white transition-all duration-200" href="#">
                            <svg height="24" version="1.1" viewBox="0 0 512 512" xmlSpace="preserve"
                    ...
                    <li className="text-center">
                        <a className="text-white/50 hover:text-white transition-all duration-200" href="#">
                            <svg width="24" height="24" fill="currentColor" version="1.1" id="Layer_1"
                                xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px"
                                y="0px" viewBox="0 0 56.7 56.7" xmlSpace="preserve">
                                <path
                    ...
                    <li className="text-center">
                        <a className="text-white/50 hover:text-white transition-all duration-200" href="#">
                            <svg height="24" id="Layer_1" version="1.1" viewBox="0 0 56.693 56.693" width="24"
                    ...
                    <li className="text-center">
                        <a className="text-white/50 hover:text-white transition-all duration-200" href="#">
                            <svg height="24" version="1.1" viewBox="0 0 512 512" width="100%" xmlSpace="preserve"
                                xmlns="http://www.w3.org/2000/svg" xmlns:serif="http://www.serif.com/"
                                xmlnsXlink="http://www.w3.org/1999/xlink" fill="currentColor">
                                <path
                    ...
                    <li className="text-center">
                        <a className="text-white/50 hover:text-white transition-all duration-200" href="#">
                            <svg height="24" id="Layer_1" version="1.1" viewBox="0 0 512 512" xmlSpace="preserve"
